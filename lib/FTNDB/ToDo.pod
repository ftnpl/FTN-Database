...
least initially having the name ftndbadm.  After moving the functionality from
ftndb-admin, could remove the ftndb-admin script.
...
Rename and move FTN::Database to FTNDB::Admin.
...
Rename and move FTN::Database::Nodelist to FTNDB::Nodelist.

Add a function to enable reading the nodelist header; it will return a hash,
with at least the ftnyear and yearday information.
...
Create an ftndb-echolist script, patterned after ftndb-nodelist, which
